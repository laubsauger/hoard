...
W8 lane split: α = lane R (T71, T74) — render/effects only, disjoint from the house-geometry/GPU-panel R work; β = lane S (T73) combat; lane A/R (T72) char rig (touches crowd/scene — sequence after T70 house pass to avoid blockScene contention).
