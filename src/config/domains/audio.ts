...
export const audioConfig = registerDomain('audio', {
  ...
  outGunshotIndoorScale: num({ owner: 'audio', unit: 'ratio', doc: 'Extra gain scale on the INDOOR gunshot sample — the room clip read too loud; toned down. 1 = no change.', default: 0.55, min: 0, max: 1 }),
  outGunshotOutdoorScale: num({ owner: 'audio', unit: 'ratio', doc: 'Extra gain scale on the OUTDOOR gunshot sample (pistol/SMG) — also read a touch loud; toned down. 1 = no change.', default: 0.62, min: 0, max: 1 }),
